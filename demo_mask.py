...
def parse_args():
    ...
    # general
    parser.add_argument('--network', help='network name', default='resnet_fpn', type=str)
    parser.add_argument('--dataset', help='dataset name', default='Cityscape', type=str)
    ...
    parser.add_argument('--result_path', help='result path', default='data/cityscape/results/', type=str)
    # testing
    parser.add_argument('--prefix', help='model to test with', default='model/final', type=str)
    ...
    parser.add_argument('--shuffle', help='shuffle data on visualization', default=False)
